...
/**
 * Title: Product Cards
 * Slug: my-custom-theme/product-cards
 * Categories: my-special-design
 * Description: แสดงการ์ดสินค้า 3 รายการ
 */
?>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group product-card has-white-background-color has-background" style="border-radius:12px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                ...
                <div class="wp-block-group" style="padding-top:25px;padding-right:25px;padding-bottom:25px;padding-left:25px">
                    ...
                    <!-- wp:paragraph {"style":{"color":{"text":"#64748b"},"spacing":{"margin":{"bottom":"20px"}}}} -->
                    <p class="has-text-color" style="color:#64748b;margin-bottom:20px">Common mode chokes, Output chokes, and various inductor solutions for power electronics</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:buttons -->
                    <div class="wp-block-buttons">
                        <!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"6px"}}} -->
                        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/product-category/inductors/" style="border-radius:6px">Learn More →</a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group product-card has-white-background-color has-background" style="border-radius:12px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                ...
                <div class="wp-block-group" style="padding-top:25px;padding-right:25px;padding-bottom:25px;padding-left:25px">
                    ...
                    <!-- wp:paragraph {"style":{"color":{"text":"#64748b"},"spacing":{"margin":{"bottom":"20px"}}}} -->
                    <p class="has-text-color" style="color:#64748b;margin-bottom:20px">Power transformers, Potential transformers designed for reliability and efficiency</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:buttons -->
                    <div class="wp-block-buttons">
                        <!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"6px"}}} -->
                        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/product-category/transformers/" style="border-radius:6px">Learn More →</a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group product-card has-white-background-color has-background" style="border-radius:12px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                ...
                <div class="wp-block-group" style="padding-top:25px;padding-right:25px;padding-bottom:25px;padding-left:25px">
                    ...
                    <!-- wp:paragraph {"style":{"color":{"text":"#64748b"},"spacing":{"margin":{"bottom":"20px"}}}} -->
                    <p class="has-text-color" style="color:#64748b;margin-bottom:20px">High-performance antenna solutions for communication and wireless applications</p>
                    <!-- /wp:paragraph -->

                    <!-- wp:buttons -->
                    <div class="wp-block-buttons">
                        <!-- wp:button {"className":"is-style-outline","style":{"border":{"radius":"6px"}}} -->
                        <div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/products/" style="border-radius:6px">Learn More →</a></div>
                        <!-- /wp:button -->
                    </div>
                    <!-- /wp:buttons -->
                </div>
